...
export default function Signup() {
  ...
  return (
    <>
    <div to={'/'} className="text-4xl  font-bold h-20 flex justify-center items-center">StarPlanner</div>
    <div className=' bg-white p-4 px-10 max-md:px-0 py-16'>
       <div>
    <Form action='/signup' method='Post'>
        <div className='flex flex-col gap-4 items-center px-40 mt-10'>
       ...
       <div className='flex flex-col gap-8'>
        <div>
             <label htmlFor='firstname' className='block text-[1.5rem] mb-4'>Firstname</label>
        ...
        <div>
             <label htmlFor='lastname' className='block text-[1.5rem] mb-4'>Lastname</label>
