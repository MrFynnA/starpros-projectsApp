...
export default function Edit(props) {
  ...
  return (
    ...
    <div className='after:content-["edit"] after:absolute hover:after:block after:hidden after:bottom-9 after:text-sm  after:max-lg:hidden after:bg-orange-600 after:text-white after:p-1 after:py-[0.1rem] after:rounded-md'>
